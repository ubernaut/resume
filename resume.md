...
- 5 years - IT Manager
- 10 years - Software Engineering Lead
...
- Managed the IT infrastructure for the FAA Weather Camera Program Office (WCPO) with 947 camera sites (305 FAA owned).
...
- Launched a 3rd party accessible API to support dissemination of camera images.
...
I'm looking for a leadership role on an ambitious team who is anticipating how current trends and technology will shape the world. Let's build the best possible future!
...
I like working on projects simultaneously, where I am creating and developing proofs of concept and then honing them into full featured products.

## Technology and concepts I'd like to work with

Aerospace, Machine Learning, computational physics, simulation, HPC, WebGPU, distributed computing, three.js, Virtual Reality, deno, WebXR, Leadership, Strategy, Linux
