...
Current AFSFM Program Manager and Software SME for AAC Previously Worked as the IT manager for WCAMS managing simultaneous software projects and operations of the camera network, websites, and infrastructure required to support them.


### Tsotchke Corporation (Jan 2026 - Present)

COO and Engineering Manager. Roles include Managing projects and daily operations for a budding startup. Several ambitious projects surrounding machine learning, programming language development, quantum computing, distributed high performance architecture etc. 
